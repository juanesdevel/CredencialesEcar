        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoEquipo = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    ...
                    CodigoUsuarioEcar = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    ...
                    UsuarioTiRegistro = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaBpm = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodigoUsuarioTi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    RolTi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    NombreUsuarioTi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UsuarioTi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ContrasenaUsuarioTi = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuariosTI", x => x.Id);
                });
